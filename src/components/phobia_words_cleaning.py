...
class PhobiaWordsCleaning:
    def __init__(self):
        ...
        phobias = {row['PHOBIAS'].lower(): self.preprocess_text(row['RELATED WORDS']) for index, row in self.dat.iterrows()}
        ...
        if phobia:
            ...
            if phobia in self.phobias:
                ...
                for word in related_words:
                    ...
                    words_to_replace = [w for w in prompt.split() if self.lemmatizer.lemmatize(w.lower()) == lemma]
