...
class TextToImage:
    def __init__(self):
        ...
        self.nsfw_pipeline = pipeline("image-classification", model="giacomoarienti/nsfw-classifier", device="cuda" if torch.cuda.is_available() else "cpu")
    ...
    def text_to_image(self, lt):
        ...
        try:
            ...
            directory_name = f"artifacts/Generated image/Generated_image_{int(time.time())}"
                        ...
                        try:                            
                            ...
                            if image:
                                ...
                                if predicted_label == "neutral" or predicted_label == "drawings":
                                    emotion_results = self.emotion_pipeline(image)  # Corrected this line
                                    emotion_predicted_label = emotion_results[0]['label']
                                    if emotion_predicted_label == "happy" or emotion_predicted_label == "neutral" or emotion_predicted_label == "surprise":
                                        j = 0
                                        desired_width = 1024
                                        desired_height = 900
                                        ...
                                        image.save(f'{directory_name}/Generated_image_{i}.jpg', 'JPEG')
                                        progress = False
                                    else:
                                        ...
                                        inp = self.summarizer.third_summarize("happy scenery image of, "+inp)
                                        print(inp)
                                        #inp = "happy scenery image of, " + inp
                                        j += 1
                                    ...
                                    inp = self.summarizer.third_summarize("scenery image of, " +inp)
                                    print(inp)
                            ...
                            inp = self.summarizer.third_summarize("a beautiful scenery image of: "+inp)
                            #inp = "a beautiful scenery image of: " + inp
                            j += 1
                            if j == 6:
                                progress = False
